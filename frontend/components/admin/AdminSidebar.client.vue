    ...
    <div class="flex p-2">
      ...
      <div class="flexcol p-2">
        ...
        <div class="flex justify-end gap-x-2 mt-2">
          <IconButton icon-source="heroicons" icon="pencil" class="btn-smp btn-secondary" @click="editAccount">Edit account</IconButton>
          <IconButton icon-source="heroicons" icon="arrow-left-start-on-rectangle-20-solid" class="btn-smp btn-secondary" @click="logout">Logout</IconButton>
        </div>
      </div>
    </div>
