...
<template>
  <div :class="{ selected }" class="flexcol relative mockup-code my-3" role="presentation">
    ...
    <select v-if="editorView?.editable" v-model="languageName" contenteditable="false" @change="onLanguageChanged()" class="select select-sm !absolute top-2 right-2 select-ghost w-full max-w-xs">
